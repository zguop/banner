...
import com.to.aboomy.bannersample.activity.ViewPagerLunchActivity;
 ...
 * date 2020-02-06
 */
public class LunchPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.view1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LunchPageActivity.this, ViewPagerLunchActivity.class);
                startActivity(i);
            }
        });
        findViewById(R.id.view2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(LunchPageActivity.this, ViewPager2LunchActivity.class);
                startActivity(i);
            }
        });
    }
