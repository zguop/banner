# Android轮播控件
[ ![Download](https://api.bintray.com/packages/a13706649811/maven/banner/images/download.svg?version=3.0.5) ](https://bintray.com/a13706649811/maven/banner/3.0.5/link)[ ![Download](https://api.bintray.com/packages/a13706649811/maven/banner/images/download.svg) ](https://bintray.com/a13706649811/maven/banner/_latestVersion)
...
```groovy
dependencies{
    implementation 'com.waitou:banner:3.0.5'  //最新版本
    implementation 'com.waitou:banner:3.0.5-x' //androidx版本
}
```
或者引用本地lib
```groovy
